...
public class FamActivity extends Activity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		Log.i("test","*****************FamActivity");
		Log.i("test", this.toString());
		setContentView(R.layout.found_sishitongtang);
		fView = (ImageView) findViewById(R.id.f_iv);
		...
		backIV= (ImageView) findViewById(R.id.f_back_iv);
		backIV.setOnClickListener(new OnClickListener() {
			
			@Override
			public void onClick(View v) {
				// TODO Auto-generated method stub
				Intent intent1=new Intent(FamActivity.this,ARMainActivity.class); 
		...
		initData();
		lv_Title = (ListView) findViewById(R.id.ftitle_lv);
...
//点击事件
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				Intent intent = new Intent(FamActivity.this,FNewsActivity.class);
				//用Bundle携带数据
