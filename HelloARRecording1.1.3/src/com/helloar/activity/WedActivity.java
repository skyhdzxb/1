...
public class WedActivity extends Activity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		Log.i("test","*****************WedActivity");
		Log.i("test", this.toString());
		setContentView(R.layout.found_tianmiyaner);
	    wView=(ImageView) findViewById(R.id.w_iv);
	    byte buff[] = this.getIntent().getByteArrayExtra("image");
	    Bitmap bitmap = BitmapFactory.decodeByteArray(buff, 0, buff.length);  
	    wView.setImageBitmap(bitmap);    
	  	backIV= (ImageView) findViewById(R.id.w_back_iv);
		backIV.setOnClickListener(new OnClickListener() {
			
			@Override
			public void onClick(View v) {
				// TODO Auto-generated method stub
				Intent intent1=new Intent(WedActivity.this,ARMainActivity.class); 
		...
		initData();
		lv_Title = (ListView) findViewById(R.id.wtitle_lv);
...
//点击事件
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				// TODO Auto-generated method stub
				Intent intent = new Intent(WedActivity.this,WNewsActivity.class);
				//用Bundle携带数据
