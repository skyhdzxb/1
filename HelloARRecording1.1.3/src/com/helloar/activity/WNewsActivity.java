...
public class WNewsActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_wnews);
		TextView tView = (TextView) findViewById(R.id.w_tv);
	...
	public void WNback(View view) {
		Intent intent = new Intent(WNewsActivity.this,WedActivity.class);
		startActivity(intent);
		Log.i("test", "从wnews详页回到列表页");
		finish();
	}
