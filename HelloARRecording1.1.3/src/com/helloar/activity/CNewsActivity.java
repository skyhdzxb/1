...
public class CNewsActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_cnews);
		TextView tView = (TextView) findViewById(R.id.c_tv);
	...
	public void CNback(View view) {
		Intent intent = new Intent(CNewsActivity.this, ChidActivity.class);
		startActivity(intent);
		Log.i("test", "从cnews详页回到列表页");
		finish();
	}
